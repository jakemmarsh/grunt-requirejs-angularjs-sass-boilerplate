...
**Note: I highly recommend using my newer [angularjs-gulp-browserify-boilerplate](https://github.com/jakemmarsh/angularjs-gulp-browserify-boilerplate) in place of this one.**
